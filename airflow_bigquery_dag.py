...
with DAG(
    ...
    with TaskGroup("load_data") as load_data:
        ...
        gcs_to_bq_merchants = GCSToBigQueryOperator(
            ...
            bucket='bigquery_projects_gds_1',
            source_objects=['walmart_ingestion/merchants/merchants.json'],
            destination_project_dataset_table='mimetic-heaven-446518-u7.walmart_dwh.merchants_tb',
        ...
        gcs_to_bq_walmart_sales = GCSToBigQueryOperator(
            ...
            destination_project_dataset_table='mimetic-heaven-446518-u7.walmart_dwh.walmart_sales_stage',
            write_disposition='WRITE_TRUNCATE',
            source_format='NEWLINE_DELIMITED_JSON',
        )
    ...
    merge_walmart_sales = BigQueryExecuteQueryOperator(
        ...
        sql="""
            MERGE `mimetic-heaven-446518-u7.walmart_dwh.walmart_sales_tgt` T
            USING (
              SELECT 
                S.sale_id, 
                S.sale_date, 
              ...
              FROM `mimetic-heaven-446518-u7.walmart_dwh.walmart_sales_stage` S
              LEFT JOIN `mimetic-heaven-446518-u7.walmart_dwh.merchants_tb` M
